...
Set-AzureRmKeyVaultAccessPolicy -ResourceGroupName $ResourceGroupOMS -VaultName $keyVaultName -ObjectId $ObjectIDWorker -PermissionsToCertificates all -PermissionsToKeys all -PermissionsToSecrets all -PermissionsToStorage all
...
New-AzureRmAutomationAccount -ResourceGroupName $ResourceGroupOMS -Name $AutomationAccountName -Location "westeurope"
